...
public class MyAccountsPageSteps {
    ...
    public void verifyTheMessageYourAccountHasBeenCreated() {
        Assert.assertEquals(new SucessPage().verifyYourAccountMessage(), "Your Account Has Been Created!", "Text not displayed");
    }

    @And("^I click on Continue button$")
    public void iClickOnContinueButton() {
        new SucessPage().clickOnSucessContinueButton();
    }
